  ...
  <section id="" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150" >
        <div class="col-xl-6 col-lg-8" style="margin-top:15%;"  >
          <?php 
          ...
          <h3 style="color:black">LISTES DES NOTES<span>.</span></h3>
          <!-- <h2>We are team of talented digital marketers</h2> -->
        </div>
        <div>
           <a style="margin-left: 90%; margin-top:-7%;" class=" btn btn-primary" href="add_note.php" ><span class="glyphicon glyphicon-plus"></span> Nouveau</a>
        </div>
      </div>
      <div class="container">
            ...
            <table  class="table table-striped table-bordered">
                <thead>
                <tr>
                    <th style="color:black">ELEVES</th>
                    <th style="color:black">MATIERES</th>
                    <th style="color:black">NOTES</th>                   
                    <th style="color:black">DATE DE COMPOSITION</th>
                    ...
                    <?php
                        ...
                        foreach($req as $row){   ?>
                            ...
                            <tr>
                                ...
                                <td  style="color:black"><?= $row['date_compo'] ?></td>                              
                                <!-- <td>
